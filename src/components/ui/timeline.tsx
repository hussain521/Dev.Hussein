...
export const Timeline = ({ data }: { data: TimelineEntry[] }) => {
  ...
  return (
    <div className="c-space section-spacing" ref={containerRef}>
      <h2 className="text-heading">My Work Experiences</h2>
        ...
        {data.map((item, index) => (
          ...
          >
            <div className="sticky z-10 flex flex-col items-center self-start max-w-xs md:flex-row top-40 lg:max-w-sm md:w-full">
              <div className="absolute z-5 flex items-center justify-center w-10 h-10 rounded-full -left-[15px] bg-midnight">
